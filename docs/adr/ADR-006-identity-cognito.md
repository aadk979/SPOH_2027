...
| ----------- | ------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------- |
| production  | **the existing pool**, imported into CDK (`cdk import`), `RemovalPolicy.RETAIN`, deletion protection on | **Essentials** within the US$100 ceiling (free under 10,000 MAU). **Plus** (threat protection, enforced) at about US$7 per event month is the recommended purchase for event months (ADR-008 §6, Q-P9) | real identities; the target of credential stuffing                                           |
...
| Threat protection             | Plus tier, **enforced**, in production event months if the owner approves Q-P9; otherwise Essentials, with MFA for admin tiers | F04-002, Q-C3    |
...
| Threat protection        | Essentials within the ceiling; Plus, enforced, in event months if Q-P9 allows | Plus all year: about US$0.60 a month off-season, but the January budget has no room for its US$7 (ADR-008 §6)                                                                                    |
