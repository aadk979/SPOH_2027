...
| --------------------- | ---------- | ------------------------------------------------------------------------- |
| `preliminary.md`      | planning   | issues seen while planning; each is verified or closed in an audit        |
| `F01-hardcoding.md`   | P01        | every event-specific / fixed value, classified, with its target home      |
| `F02-journeys.md`     | P02        | role journeys, dead ends, missing screens, the interlinking matrix        |
| `F02-screens/`        | P02        | screenshots referenced from F02 (phone + laptop)                          |
